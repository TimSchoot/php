                ...
                <div class="card-body">
                  ...
                  <!-- id's zijn bedacht op basis van Excel-cellen -->
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col"><input id="inp_D3" type="text" class="form-control text-center" disabled value=""></div>
                    </div>
                    <div class="row mt-2">
                        <div class="col"></div>
                  ...
                  <div class="row">
                    <div class="col">
                      <a href="#" class="btn btn-primary mt-3" onclick="generateProblem()">genereer</a>
                    </div>
                    <div class="col">
                      <a href="#" class="btn btn-success mt-3" onclick="checkSolution()">check</a>
                    </div>
                  </div>
                </div>
